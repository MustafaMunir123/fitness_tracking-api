# Generated by Django 3.2.5 on 2023-07-16 18:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('complete_details', models.BooleanField(blank=True, default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_attempted', models.CharField(blank=True, max_length=40, null=True)),
                ('done', models.BooleanField(default=False, null=True)),
                ('focus', models.CharField(blank=True, max_length=50)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_exercise', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='UserDetail',
            fields=[
                ...
                ('ini_height', models.FloatField(blank=True)),
                ('ini_weight', models.FloatField(blank=True)),
                ('ini_sleep', models.FloatField(blank=True)),
                ('ini_walk', models.FloatField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(blank=True, choices=[('FAT_LOSS', 'Fat Loss'), ('MUSCLE_BUILDING', 'Muscle Building'), ('CARDIO', 'Cardio'), ('FLEXIBILITY', 'Flexibility')], max_length=50)),
